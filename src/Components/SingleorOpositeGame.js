    ...
    return(
        ...
        <>
            <div className='flex justify-center items-center flex-col w-full max-w-full'>
                <div className="enterNames sm:flex max-w-full w-full md:w-fit d-sm-block">
                    <div className="score_names md:max-w-full md:w-full">
                    ...
                    <img className="cuppic w-16 h-16 m-auto sm:my-3 md:mr-2 mt-2 lg:mt-5" src="https://cdn-icons-png.flaticon.com/512/4049/4049075.png" alt=""/>
                    <div className="score_names md:max-w-full md:w-full">
                        <div className="text-center text-2xl mb-1 sm:text-4xl">Player 2</div>
                        <input onChange={(e=>{setsecondplayer(e.target.value)})} className='max-w-full w-full sm:w-64 rounded-xl border-0 px-3 h-10 outline-none' placeholder='Adınızı daxil edin' type="text" />
                    </div>
                </div>
